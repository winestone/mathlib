...
condexp_L1s_mono hm ((L1.simple_func.map_coe abs f).mono (λ x hx, by {rw hx, exact le_abs_self _}))
...
begin
  ...
  { refine condexp_L1s_nonneg hm ((L1.simple_func.map_coe F f).mono (λ x hx, _)),
    rw [hx, pi.zero_apply],
