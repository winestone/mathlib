...
@[simp] lemma set.subinterval.is_measurable_pi_Ioc {ι} [encodable ι] {s : set (ι → α)}
  (I : s.subinterval) : is_measurable I.pi_Ioc :=
is_measurable_pi (countable_encodable _) (λ i hi, is_measurable_Ioc)
